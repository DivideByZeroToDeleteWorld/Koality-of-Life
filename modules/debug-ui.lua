...
local function CreateConsoleFrame()
    ...
    frame:SetBackdropColor(0.02, 0.02, 0.02, 0.98)  -- Much darker background
    ...
    contentBG:SetBackdropColor(0.01, 0.01, 0.01, 1)  -- Nearly black for max readability
    contentBG:SetBackdropBorderColor(0.25, 0.25, 0.25, 1)
    ...
    pauseButton:SetBackdropColor(0.8, 0.6, 0.2, 1)  -- Orange/yellow color
    pauseButton:SetBackdropBorderColor(0.2, 0.2, 0.2, 1)
    ...
    pauseText:SetTextColor(1, 1, 0.6, 1)
    ...
    clearButton:SetBackdropColor(0.8, 0.4, 0.4, 1)
    clearButton:SetBackdropBorderColor(0.2, 0.2, 0.2, 1)
    ...
    clearText:SetTextColor(1, 1, 0.6, 1)
    ...
    closeButton:SetBackdropColor(0.8, 0.4, 0.4, 1)
    closeButton:SetBackdropBorderColor(0.2, 0.2, 0.2, 1)
    ...
    closeText:SetTextColor(1, 1, 0.6, 1)
...
local function CreateDebugButton()
    ...
    button:SetBackdropColor(0.15, 0.15, 0.15, 0.8)  -- Semi-transparent dark gray
    button:SetBackdropBorderColor(0.4, 0.4, 0.4, 0.9)  -- Mid gray border
    ...
    text:SetText("D")
    text:SetTextColor(1, 0.4, 0.4, 1)  -- Red-ish color
    button.text = text
    ...
    button:SetScript("OnLeave", function(self)
        self:SetBackdropColor(0.15, 0.15, 0.15, 0.8)  -- Back to normal
        self:SetBackdropBorderColor(0.4, 0.4, 0.4, 0.9)
        self.text:SetTextColor(1, 0.4, 0.4, 1)
        GameTooltip:Hide()
