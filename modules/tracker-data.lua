...
KOL.Tracker:RegisterInstance("uld_10", {
    ...
    bosses = {
        ...
        {name = "Assembly of Iron", id = 32867},
        {name = "Kologarn", id = 32930},
        {name = "Auriaya", id = 33515},
        {name = "Hodir", id = 32845},
        {name = "Thorim", id = 32865},
        {name = "Freya", id = 32906},
        {name = "Mimiron", id = 33350},
        {name = "General Vezax", id = 33271},
        {name = "Yogg-Saron", id = 33288},
        {name = "Algalon the Observer", id = 32871},
    }
})
...
KOL.Tracker:RegisterInstance("toc_10", {
    ...
    bosses = {
        {name = "The Beasts of Northrend", id = 34797},
        {name = "Lord Jaraxxus", id = 34780},
        {name = "Faction Champions", id = 34461},
...
KOL.Tracker:RegisterInstance("icc_10", {
    ...
    groups = {
        ...
        },
        {
            ...
            bosses = {
                {name = "Valithria Dreamwalker", id = 36789},
...
KOL.Tracker:RegisterInstance("toc5_n", {
    ...
    bosses = {
        {name = "Grand Champions", id = 35328},
        {name = "Argent Confessor Paletress", id = 34928},
        {name = "The Black Knight", id = 35451},
    }
})
