...
print("========== TESTS.LUA LOADING ==========")
print("KoalityOfLife exists: " .. tostring(KoalityOfLife ~= nil))

local addonName = "Koality-of-Life"
local KOL = KoalityOfLife

print("KOL assigned: " .. tostring(KOL ~= nil))
print("Attempting to get LibSharedMedia-3.0...")
...
-- Create module
print("Creating Tests module...")
local Tests = {}
print("Assigning KOL.tests...")
KOL.tests = Tests
print("Tests module created successfully!")
...
function Tests:RegisterCommands()
    ...
    print("[TESTS DEBUG] RegisterCommands() called at " .. GetTime())
    print("[TESTS DEBUG] KOL exists: " .. tostring(KOL ~= nil))
    print("[TESTS DEBUG] KOL.RegisterSlashCommand exists: " .. tostring(KOL and KOL.RegisterSlashCommand ~= nil))
    ...
    print("[TESTS DEBUG] Total commands registered: " .. registeredCount)

    -- Debug: Check what's actually in KOL.slashCommands
    print("[TESTS DEBUG] Checking KOL.slashCommands table:")
    local totalInTable = 0
    local testInTable = 0
    for cmd, data in pairs(KOL.slashCommands) do
        totalInTable = totalInTable + 1
        if data.category == "test" then
            testInTable = testInTable + 1
            print("[TESTS DEBUG]   - " .. cmd .. " (category: " .. tostring(data.category) .. ")")
        end
    end
    print("[TESTS DEBUG] Total in slashCommands: " .. totalInTable .. ", Test category: " .. testInTable)
...
print("[TESTS DEBUG] tests.lua loaded, calling RegisterCommands()...")
Tests:RegisterCommands()
print("[TESTS DEBUG] RegisterCommands() call completed")
