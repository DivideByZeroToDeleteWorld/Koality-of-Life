...
do
	...
	-- exported
	local sortlist = {}
	-- Custom comparator that handles mixed types (strings, numbers, booleans)
	local function mixedCompare(a, b)
		local ta, tb = type(a), type(b)
		-- Same type: use native comparison (except booleans)
		if ta == tb then
			if ta == "boolean" then
				-- false < true
				return not a and b
		...
		-- Different types: sort by type name, then by value as string
		return ta < tb
	end
